      ...
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          _metricGrid([
            ...
            _PdfMetric('Metas atingidas', '${report.goalsReached}/4'),
            _PdfMetric('Periodo', report.period.label),
            _PdfMetric('Semana', report.weeklyPeriodLabel),
            _PdfMetric('Semanal ind.', percent(report.weeklyIndividualPercent)),
            _PdfMetric('Semanal loja', percent(report.weeklyStorePercent)),
          ]),
          pw.SizedBox(height: 22),
